...
def process_command():
	...
	parser.add_argument('--c', '-c', default=50, help='channel size', type=int )
	parser.add_argument('--b', '-b', default=64, help='batch size', type=int )
	parser.add_argument('--e', '-e', default=25, help='epoch', type=int )
